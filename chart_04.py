...
ax.plot(df.index, df['close'].rolling(5).mean(), color='r', linewidth=1.5, label="MA(5)")
...
ax.plot(df.index, df['close'].rolling(300).mean(), color='pink', linestyle='solid', linewidth=0.5, label="MA(300)")
...
ax.plot(df.index, d1['BBANDS_upperband'], color='lightpink', linewidth=0.5, label="bb_upp_1")
ax.plot(df.index, d1['BBANDS_lowerband'], color='lightpink', linewidth=0.5, label="bb_low_1")
...
ax.plot(df.index, d2['BBANDS_upperband'], color='lightgreen', linewidth=0.5, label="bb_upp_2")
ax.plot(df.index, d2['BBANDS_lowerband'], color='lightgreen', linewidth=0.5, label="bb_low_2")
#pprint(d)%exit()
...
#axvspan
ax.axvspan(60, 70, facecolor = "red", alpha=0.2)
